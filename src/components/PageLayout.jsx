...
function NavItem({ to, label, icon, external, isActive, collapsed }) {
  const cls = [
    "flex items-center gap-3 px-2 py-2 rounded-lg text-sm font-medium transition-colors relative",
    isActive
      ? "bg-pink-600/30 text-white ring-1 ring-pink-500/60"
  ...
  if (external) {
    return (
      <a href={to} target="_blank" rel="noopener noreferrer" className={cls} title={collapsed ? label : undefined}>
        {inner}
      </a>
    );
  }
...
export const PageLayout = (props) => {
  ...
  const navItems = [
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
          <path d="M3 10.5L12 3L21 10.5V20C21 20.5523 20.5523 21 20 21H15V16H9V21H4C3.44772 21 3 20.5523 3 20V10.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
    },
    {
      ...
      external: false,
      icon: (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490 490" width="20" height="20">
          <g><g><g>
            <path d="M10,372.5h405c2.602-0.001,5.159-1.016,7.071-2.929l65-65c1.912-1.913,2.904-4.47,2.905-7.071H490v-245c0-5.522-4.477-10-10-10H10c-5.523,0-10,4.478-10,10v310C0,368.022,4.477,372.5,10,372.5z M425,338.357V307.5h30.858L425,338.357z M20,62.5h450v225h-55c-5.523,0-10,4.478-10,10v55H20V62.5z" />
            <path d="M350,92.5H250c-5.523,0-10,4.478-10,10v15h-25c-5.523,0-10,4.478-10,10v75h-80v-35h55c5.523,0,10-4.478,10-10v-60c0-5.522-4.477-10-10-10H60c-5.523,0-10,4.478-10,10v60c0,5.522,4.477,10,10,10h45v45c0,5.522,4.477,10,10,10h90v70c0,5.522,4.477,10,10,10h25v10c0,5.522,4.477,10,10,10h100c5.523,0,10-4.478,10-10v-50c0-5.522-4.477-10-10-10H250c-5.523,0-10,4.478-10,10v20h-15v-60h15v10c0,5.522,4.477,10,10,10h100c5.523,0,10-4.478,10-10v-50c0-5.522-4.477-10-10-10H250c-5.523,0-10,4.478-10,10v20h-15v-65h15v15c0,5.522,4.477,10,10,10h100c5.523,0,10-4.478,10-10v-50C360,96.978,355.523,92.5,350,92.5z M70,147.5v-40h100v40H70z M260,272.5h80v30h-80V272.5z M260,192.5h80v30h-80V192.5z M340,142.5h-80v-30h80V142.5z" />
            <rect x="50" y="247.5" width="75" height="20" /><rect x="50" y="277.5" width="75" height="20" /><rect x="50" y="307.5" width="130" height="20" /><rect x="135" y="247.5" width="20" height="20" /><rect x="380" y="92.5" width="25" height="20" /><rect x="420" y="92.5" width="25" height="20" /><rect x="380" y="122.5" width="25" height="20" /><rect x="420" y="122.5" width="25" height="20" /><rect x="380" y="152.5" width="25" height="20" /><rect x="420" y="152.5" width="25" height="20" /><rect x="380" y="182.5" width="25" height="20" /><rect x="420" y="182.5" width="25" height="20" />
            <path d="M483.162,408.013l-60-20c-1.033-0.344-2.1-0.498-3.162-0.498V387.5H10c-5.523,0-10,4.478-10,10v40c0,5.522,4.477,10,10,10h410h0.001c1.061,0,2.129-0.169,3.161-0.513l60-20c4.083-1.361,6.838-5.183,6.838-9.487C490,413.196,487.246,409.374,483.162,408.013z M60,427.5H20v-20h40V427.5z M410,427.5H80v-20h330V427.5z M430,423.626v-12.252l18.377,6.126L430,423.626z" />
          </g></g></g>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20">
          <g><g><g>
            <path d="M93.867,256H256c4.71,0,8.533-3.823,8.533-8.533s-3.823-8.533-8.533-8.533l-153.6-0.017V85.333l8.491-0.009c0.017,0,0.026,0.009,0.043,0.009c0.017,0,0.026-0.009,0.043-0.009l93.15-0.094c0.239,0.102,0.649,0.563,0.674,0.102v59.733c0,4.71,3.823,8.533,8.533,8.533c4.71,0,8.533-3.823,8.533-8.533V85.333c0-8.772-8.294-17.067-17.067-17.067h-85.333v-25.6c0-4.71-3.823-8.533-8.533-8.533s-8.533,3.823-8.533,8.533v25.6c-9.25,0-17.067,7.817-17.067,17.067v162.133C85.333,252.177,89.156,256,93.867,256z" />
            <path d="M503.467,426.667h-13.244c-7.219-8.602-29.423-38.869-29.423-85.333c0-46.481,22.229-76.757,29.423-85.333h13.244c4.71,0,8.533-3.823,8.533-8.533s-3.823-8.533-8.533-8.533H486.4c-2.261,0-4.437,0.896-6.033,2.5c-1.425,1.425-33.348,34.133-36.335,91.366h-10.24l-15.795-86.861c-0.742-4.053-4.275-7.006-8.397-7.006H297.071c-1.306-5.675-3.507-14.208-6.886-27.358c-5.41-25.992-24.098-40.909-51.251-40.909H175.94l10.889-21.786c2.116-4.215,0.401-9.335-3.814-11.452c-4.215-2.108-9.344-0.393-11.452,3.823l-14.703,29.414H128c-4.71,0-8.533,3.823-8.533,8.533c0,4.71,3.823,8.533,8.533,8.533h110.933c13.158,0,29.841,4.745,34.637,27.708c3.669,14.293,7.757,30.438,8.346,33.161c0.12,0.905,0.384,1.801,0.802,2.637c1.434,2.918,4.395,4.762,7.646,4.762h112.111l15.795,86.861c0.734,4.053,4.275,7.006,8.397,7.006h17.365c2.987,57.233,34.91,89.941,36.335,91.366c1.596,1.604,3.772,2.5,6.033,2.5h17.067c4.71,0,8.533-3.823,8.533-8.533S508.177,426.667,503.467,426.667z" />
            <path d="M136.55,358.383c0-28.228-22.972-51.2-51.2-51.2c-28.237,0-51.2,22.972-51.2,51.2c0,28.237,22.963,51.2,51.2,51.2C113.579,409.583,136.55,386.62,136.55,358.383z M85.35,392.516c-18.825,0-34.133-15.309-34.133-34.133S66.526,324.25,85.35,324.25c18.816,0,34.133,15.309,34.133,34.133S104.166,392.516,85.35,392.516z" />
            <path d="M273.067,358.383c0,28.237,22.963,51.2,51.2,51.2c28.237,0,51.2-22.963,51.2-51.2c0-28.228-22.963-51.2-51.2-51.2C296.03,307.183,273.067,330.155,273.067,358.383z M324.267,324.25c18.825,0,34.133,15.309,34.133,34.133s-15.309,34.133-34.133,34.133c-18.825,0-34.133-15.309-34.133-34.133S305.442,324.25,324.267,324.25z" />
            <path d="M264.533,460.8H8.533C3.823,460.8,0,464.623,0,469.333s3.823,8.533,8.533,8.533h256c4.71,0,8.533-3.823,8.533-8.533S269.244,460.8,264.533,460.8z" />
            <path d="M503.467,460.8H366.933c-4.71,0-8.533,3.823-8.533,8.533s3.823,8.533,8.533,8.533h136.533c4.71,0,8.533-3.823,8.533-8.533S508.177,460.8,503.467,460.8z" />
          </g></g></g>
        </svg>
      ),
    },
    {
      ...
      external: false,
      icon: (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="20" height="20">
          <rect x="48" y="64.2" width="68.9" height="5.6" />
          <circle cx="51.7" cy="18.3" r="12.3" />
          <path d="M60.3,73H39.6V57.6L28.9,39.3c-0.4-0.7-0.1-1.7,0.5-2.1c0.7-0.4,1.7-0.1,2.1,0.5l12.3,21.2c0.9,1.6,2.6,2.7,4.6,2.7h21.2c3,0,5.4-2.5,5.4-5.4c0-3-2.5-5.4-5.4-5.4L51.9,51L37.8,27.2c-1-1.9-3.1-2.9-5.6-2.9c-0.3,0-1.1,0.1-1.5,0.2c-0.3,0.1-0.8,0.2-1.1,0.3C19.2,28.2,11,44.6,11,61.5c-0.1,5.1,0,9.4,0.3,13.5c-0.4,4.9,2.5,9.7,7.3,11.5c1.3,0.4,2.5,0.7,3.8,0.7h30.9v28.9c0,4,3.1,7,7,7c4,0,7-3.1,7-7v-36c0-1.8-0.7-3.7-2.1-4.9C63.8,73.8,62,73,60.3,73z" />
          <path d="M80.5,36.5c1,0.9,2.1,1.3,3.5,1.2c0.5,0,1-0.1,1.5-0.3l6,5.5l-9.9,10.2c-0.7,0.6-1,1.4-1,2.3c0,1.7,1.3,3,3,3c1,0,1.9-0.5,2.5-1.3l9.5-10.5l5.6,5.1l0.9,0.9c-0.1,0.5-0.2,1-0.2,1.5c0.1,1.3,0.6,2.4,1.6,3.4c1,0.9,2.1,1.3,3.5,1.2c0.5,0,0.9-0.1,1.3-0.3l-3.9-3.5l3.5-3.8l3.9,3.5c0.1-0.5,0.2-0.9,0.1-1.3c-0.1-1.3-0.6-2.4-1.6-3.3c-1-0.9-2.1-1.3-3.5-1.2c-0.5,0-0.9,0.1-1.3,0.3l-6.7-6.2l4.3-5.1l6.9,6.1l6.1-6.9L98.8,21.7l-6.1,6.9l6.7,5.9L95,39.4l-6.1-5.6c0.1-0.5,0.2-0.9,0.1-1.3c-0.1-1.3-0.6-2.5-1.6-3.4s-2.1-1.3-3.5-1.2c-0.5,0-0.9,0.1-1.3,0.3l3.9,3.5L83,35.4l-3.9-3.5c-0.1,0.5-0.2,0.9-0.1,1.3C79,34.5,79.5,35.6,80.5,36.5z" />
        </svg>
      ),
    },
    {
      ...
      external: false,
      icon: (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="-351 153 256 256" width="20" height="20">
          <path d="M-139.1,345.7c-6.5-5.9-14.1-8.6-23-8.3c-3,0-5.9,0.7-8.9,1.7l-44.6-40.8l28.7-33.9l45.6,40.2l40.3-45.9l-114.1-100.4l-40.3,45.9l44.4,39.1l-29.7,32.1l-40.6-37.2c0.7-3,1-5.9,0.7-8.9c-0.3-8.9-3.8-16.5-10.3-22.3c-6.5-5.9-14.1-8.6-23-8.3c-3,0-6.2,0.7-8.9,1.7l25.8,23.4l-22.8,25l-25.8-23.4c-0.7,3-1,6.2-0.7,8.9c0.3,8.9,3.8,16.1,10.3,22c6.5,5.9,14.1,8.6,23,8.3c3,0,6.5-0.7,9.6-2.1l39.4,36.1l-65.2,67.6c-4.5,3.8-6.8,9.2-6.8,15.1c0,11,8.9,19.9,19.9,19.9c6.8,0,12.7-3.5,16.5-8.6l62.8-69.2l37.1,33.9l6.2,5.9c-0.7,3-1,6.5-1,9.6c0.3,8.9,3.8,16.1,10.3,22.3c6.5,5.9,14.1,8.6,23,8.3c3,0,5.9-0.7,8.9-1.7l-25.8-23.4l23-25.1l25.5,23.5c0.7-3,1-6.2,0.7-8.9C-129.1,358.7-132.6,351.5-139.1,345.7z" />
        </svg>
      ),
    },
    {
      ...
      external: true,
      icon: (
        <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor">
          <path d="M18.979,4.661c-2.212,0.573-4.284,1.494-6.129,2.735L9.857,4.402l-5.656,5.657l3.042,3.042c-1.163,1.784-2.036,3.766-2.583,5.883H0v10.031h4.66c0.56,2.165,1.458,4.193,2.66,6.009l-3.118,3.118l5.656,5.656l3.119-3.118c1.819,1.205,3.853,2.104,6.023,2.664V48h4.062v-8.047C14.665,39.465,8,32.52,8,24c0-8.521,6.665-15.465,15.062-15.953V0h-4.083V4.661z" />
          <path d="M15,24c0,4.654,3.532,8.482,8.062,8.951v-4.046C20.75,28.466,19,26.44,19,24c0-2.44,1.75-4.466,4.062-4.905v-4.046C18.532,15.518,15,19.346,15,24z" />
    ...
    },
    {
      ...
      external: true,
      icon: (
        <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor">
      ...
      icon: (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20">
          <g><g><g>
            ...
            <path d="M341.333,298.667C329.551,298.667,320,308.218,320,320s9.551,21.333,21.333,21.333C364.901,341.333,384,360.433,384,384c0,11.782,9.551,21.333,21.333,21.333c11.782,0,21.333-9.551,21.333-21.333C426.667,336.869,388.465,298.667,341.333,298.667z" />
            <path d="M341.333,362.667C329.557,362.667,320,372.224,320,384s9.557,21.333,21.333,21.333c11.776,0,21.333-9.557,21.333-21.333S353.109,362.667,341.333,362.667z" />
          </g></g></g>
        </svg>
      ),
    },
    {
      ...
      external: false,
      icon: (
        <svg fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <nav className="flex-shrink-0 w-full bg-pink-700 text-pink-400 shadow-md">
              ...
              {isAuthenticated ? (
                <div className="relative" ref={profileRef}>
                  <button
                    ...
                    className="w-9 h-9 rounded-full bg-pink-900 border-2 border-pink-500/60 hover:border-pink-300 flex items-center justify-center text-sm font-bold text-pink-200 hover:text-white transition-colors"
                    title={name}
                  >
                    {initials}
                  </button>
                    ...
                    <div className="absolute right-0 mt-2 w-52 bg-gray-900 border border-gray-700 rounded-xl shadow-xl z-50 overflow-hidden">
                      ...
                      <div className="p-1.5 flex flex-col gap-0.5">
                        <Link
                          ...
                          className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-gray-800 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-gray-800 transition-colors w-full text-left"
                        >
                          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                            <path d="M17 16L21 12M21 12L17 8M21 12H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M13 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                          </svg>
                          Sign out
                        </button>
                      </div>
            ...
            {visibleItems.map((item) => {
              ...
              return (
                <NavItem
                  ...
                  isActive={isActive && !item.external}
                  collapsed={collapsed}
                />
              );
            })}
          ...
          {isAuthenticated && (
            <div className="p-1.5 border-t border-gray-700 flex-shrink-0">
              <button
                onClick={() => instance.logoutRedirect({ postLogoutRedirectUri: window.location.origin }).catch(console.error)}
                title="Sign out"
                className="flex items-center gap-3 px-2 py-2 rounded-lg text-sm font-medium w-full text-gray-400 hover:text-white hover:bg-gray-800 transition-colors"
              >
